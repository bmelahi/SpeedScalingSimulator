...
/*----------------------------------------------------------------------
* FSPEI.h - definitions/declarations for class FSPEI
*
*       Written by Maryam Elahi
*		Last (remembered) updated: Nov 2012
*
*Purpose:
*       This file defines the class FSPEI, with its members and methods.
*
*///---------------------------------------------------------------------
