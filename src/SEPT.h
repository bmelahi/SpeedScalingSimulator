...
#define _SEPT_h_
/*----------------------------------------------------------------------
* SEPT.h - definitions/declarations for class SEPT(Non Preemptive)
*
*       Written by Mithun P
*		Last Updated: July 2022
*
*Purpose:
*       This file defines the class SEPT(Non Preemptive), with its members and methods.
*
*///---------------------------------------------------------------------
...
private:
	std::priority_queue<Job*, std::vector<Job*>, CompareJobSEPT> jobs_q;	// The queue of jobs in the system
	Job* current_job_m;
