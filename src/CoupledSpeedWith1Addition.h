...
#ifndef _CoupledSpeedWith1Addition_h_

	#define _CoupledSpeedWith1Addition_h_
...
//----------------------------------------------------------------------
	...
	class CoupledSpeedWith1Addition : public SpeedScaler {
	public:
		CoupledSpeedWith1Addition(double base, PowerFunction * P);
		~CoupledSpeedWith1Addition();
