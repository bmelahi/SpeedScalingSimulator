...
#ifndef _ShadowSpeedEstimateSize_h_

	#define _ShadowSpeedEstimateSize_h_

/*----------------------------------------------------------------------
* ShadowSpeedEstimateSize.h - definitions/declarations for class ShadowSpeedEstimateSize
*
*       Written by Maryam Elahi
*		Last (remembered) updated: Nov 2012
*
*Purpose:
*       This file defines the class ShadowSpeedEstimateSize, which uses 
...
//----------------------------------------------------------------------
	...
	class ShadowSpeedEstimateSize: public SpeedScaler {
	public:
		ShadowSpeedEstimateSize(double base, PowerFunction * P, Scheduler * shadow);
		~ShadowSpeedEstimateSize();
